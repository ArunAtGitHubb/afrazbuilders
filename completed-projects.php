...
$query2 = "SELECT COUNT(id) as total_record FROM smartend_topics where webmaster_id = 2 and status =1 and project_type='Completed' and id != 150 ";
...
$offset = ($currentpage - 1) * $pageSize;
 ...
 // $query = "SELECT * FROM smartend_topics where webmaster_id = 2 and status =1 and project_type='Completed' and id != 150 order by id desc LIMIT $offset, $pageSize";
