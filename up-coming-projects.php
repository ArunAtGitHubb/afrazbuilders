...
$query2 = "SELECT COUNT(id) as total_record FROM smartend_topics where webmaster_id = 2 and status =1 and project_type='Up Coming' and id != 150 ";
...
$query = "SELECT * FROM smartend_topics where webmaster_id = 2 and status =1 and project_type='Up Coming' and id != 150 order by id desc ";
